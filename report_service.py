...
<form method="post" action="/generate" onsubmit="var b=this.querySelector('button[type=submit]');b.disabled=true;b.textContent='⏳ Bericht wird erstellt…';">
...
<input type="text" name="date" placeholder="TT.MM.JJJJ" pattern="[0-9]{2}\.[0-9]{2}\.[0-9]{4}" inputmode="numeric" required></div>
