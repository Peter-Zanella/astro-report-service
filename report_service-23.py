...
<div style="margin-top:22px;padding:14px;border:1px dashed {PAL['gold']};border-radius:6px">
  ...
  <div class="row">
    ...
    <input type="date" name="birth_date" min="1900-01-01" max="2030-12-31"></div>
            ...
            try:
                ...
                if not bloc:
                    return HTMLResponse(msg_html(
                        ...
                        "Geburtsfelder leer lassen.", "err"), 400)
                ...
                chart["janma_context"] = {
                    ...
                    "mahadasha_ends": (act["end"].strftime("%d %b %Y")
                                       if act else None),
                    "house_lords": lords,
                }
                ...
                return HTMLResponse(msg_html(
                    ...
                    "Die optionalen Geburtsangaben konnten nicht gelesen "
                    "werden. Bitte prüfen — oder alle drei Felder leer "
                    "lassen.", "err"), 400)
